...
// var_dump($this->session->tempdata('hasil'));
// die;
?>
                                    ...
                                    <div class="col-md-9 col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <span class="card-title float-right"><?= "Rp " . number_format($k['price'], null, null, '.'); ?></span>
                                                <h5 class="card-title"><?= $k['name'] ?></h5>
                                            </div>
                                        </div>
                                        <div class="accordion accordion-primary">
                                            <div class="card">
                                                <div class="card-header" id="headingOne" data-toggle="collapse" data-target="#Deskripsi-<?= $i ?>" aria-expanded="true" aria-controls="Deskripsi">
                                                    <div class="span-icon">
                                                        <div class="flaticon-interface-6"></div>
                                                    </div>
                                                ...
                                                <div id="Deskripsi-<?= $i ?>" class="collapse show" aria-labelledby="Deskripsi" data-parent="#accordion" style="background-color: #fff;">
                                                    <div class="card-body">
                                                        <?= $k['desc'] ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingOne" data-toggle="collapse" data-target="#Informasi-<?= $i ?>" aria-expanded="true" aria-controls="Informasi">
                                                    <div class="span-icon">
                                                        <div class="flaticon-layers-1"></div>
                                                    </div>
                                                    <div class="span-title">
                                                        Informasi
                                                    </div>
                                                ...
                                                <div id="Informasi-<?= $i ?>" class="collapse" aria-labelledby="Informasi" data-parent="#accordion" style="background-color: #fff;">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col">
