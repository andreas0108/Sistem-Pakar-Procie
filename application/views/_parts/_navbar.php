...
<div class="container-fluid">
	...
	<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
		...
		<!-- Quick Sidebar -->
		<!-- Add quick-sidebar part in main view if you want to use thhis -->
		<!-- <li class="nav-item">
				...
				<div class="dropdown-user-scroll scrollbar-outer">
					<li>
						<div class="user-box">
							...
							<div class="u-text">
								<h4>Hizrian</h4>
								<p class="text-muted">hello@example.com</p><a href="https://themekita.com/demo-atlantis-bootstrap/livepreview/examples/demo1/forms/profile.html" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
							</div>
						</div>
					</li>
					<li>
