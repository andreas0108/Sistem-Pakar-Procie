								...
								<div class="card">
									<div class="card-body pad">
										<div class="form-group">
											<input type="text" name="title" class="form-control focus" placeholder="Judul" required>
										</div>
										<div class="form-group">
											<textarea id="isi" name="isi" class="form-control" placeholder="Mulai Menulis"><?= $this->input->post('isi') ?></textarea>
										</div>
									</div>
								</div>
								<!-- /.card -->
