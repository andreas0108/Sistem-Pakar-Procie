															...
															<tr>
																...
																<td>
																	<div class="btn-group float-right" role="group" aria-label="Basic example">
																		...
																		<a href="<?= base_url('dashboard/komponen/hapus/') . $k['id']; ?>" title="hapus artikel" type="button" class="btn btn-sm btn-danger btn-remove" data-text="Artikel"><i style="color: white" class="fa fa-trash"></i></a>
																	</div>
																</td>
															</tr>
														<?php endforeach ?>
